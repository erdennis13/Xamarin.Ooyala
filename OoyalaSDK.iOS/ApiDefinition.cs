...
namespace OoyalaSDK.iOS
{
    ...
    //    [Field("OOOoyalaPlayerBufferingCompletedNotification", "__Internal")]
    ...
    //    [Field("OOOoyalaPlayerAudioTrackChangedNotification", "__Internal")]
    ...
    {
        // @property (readonly, nonatomic) type;
        [Export("type")]
        OOType Type { get; }
    ...
    //    [Field("OOOoyalaPlayerViewControllerInlineViewVisible", "__Internal")]
    ...
    //    [Field("OOOoyalaPlayerViewControllerFullscreenViewVisible", "__Internal")]
    ...
    // @interface OOTransparentToolbar : UIToolbar
    [BaseType(typeof(UIToolbar))]
    interface OOTransparentToolbar
    {
    }
    ...
    [Protocol, Model]
    [BaseType(typeof(NSObject))]
    interface OOCuePointViewDurationDataSource
    {
    ...
    {
        // @property (nonatomic) NSSet * cuePointsAtSeconds;
        [Export("cuePointsAtSeconds", ArgumentSemantic.Assign)]
        NSSet CuePointsAtSeconds { get; set; }
        ...
        [Export("initWithFrame:padding:durationDataSource:diameter:")]
        IntPtr Constructor(CGRect frame, float padding, OOCuePointViewDurationDataSource durationDataSource, float diameter);
    }

    // @interface OOProgressSliderView : UIView <OOCuePointViewDurationDataSource>
    [BaseType(typeof(UIView))]
    interface OOProgressSliderView : OOCuePointViewDurationDataSource
    {
        ...
        [Export("currentAvailableTime")]
        float CurrentAvailableTime { get; set; }

        // @property (nonatomic) OOUIProgressSliderMode mode;
        [Export("mode", ArgumentSemantic.Assign)]
        OOUIProgressSliderMode Mode { get; set; }

        // @property (nonatomic) CMTimeRange seekableTimeRange;
        [Export("seekableTimeRange", ArgumentSemantic.Assign)]
        CMTimeRange SeekableTimeRange { get; set; }

        // @property (nonatomic) UILabel * liveIndicator;
        [Export("liveIndicator", ArgumentSemantic.Assign)]
        UILabel LiveIndicator { get; set; }

        // @property (nonatomic) UISlider * scrubber;
        [Export("scrubber", ArgumentSemantic.Assign)]
        UISlider Scrubber { get; set; }

        // @property (nonatomic) UISlider * bufferSlider;
        [Export("bufferSlider", ArgumentSemantic.Assign)]
        UISlider BufferSlider { get; set; }
        ...
        [Export("updateTimeDisplay")]
        void UpdateTimeDisplay();

        // -(Float64)scrubberAbsoluteValue;
        [Export("scrubberAbsoluteValue")]
        //[Verify(MethodToProperty)]
        double ScrubberAbsoluteValue { get; }

        // -(void)drawLiveIndicator;
        [Export("drawLiveIndicator")]
        void DrawLiveIndicator();
    }
    ...
    interface OOBufferView
    {
        ...
        [Export("initWithFrame:slider:")]
        IntPtr Constructor(CGRect frame, OOProgressSliderView slider);
    }
    ...
    interface OOClosedCaptionsSelectorViewController
    {
        ...
        IntPtr Constructor(OOOoyalaPlayerViewController c);
    ...
    interface OOClosedCaptionsSelectorBackgroundViewController
    {
        ...
        [Export("initWithSelectorView:")]
        IntPtr Constructor(OOClosedCaptionsSelectorViewController selectorController);
    }
    ...
    interface OOImages
    {
        ...
        [Static]
        [Export("playImage:")]
        UIImage SetPlayImage(CGSize size);

        // +(UIImage *)pauseImage:(CGSize)size;
        [Static]
        [Export("pauseImage:")]
        UIImage SetPauseImage(CGSize size);

        // +(UIImage *)maximizeImage:(CGSize)size;
        [Static]
        [Export("maximizeImage:")]
        UIImage SetMaximizeImage(CGSize size);

        // +(UIImage *)nextImage:(CGSize)size;
        [Static]
        [Export("nextImage:")]
        UIImage SetNextImage(CGSize size);

        // +(UIImage *)previousImage:(CGSize)size;
        [Static]
        [Export("previousImage:")]
        UIImage SetPreviousImage(CGSize size);

        // +(UIImage *)closedCaptionsImage;
        [Static]
        [Export("closedCaptionsImage")]
        //[Verify(MethodToProperty)]
        UIImage ClosedCaptionsImage { get; }

        // +(UIImage *)expandImage;
        [Static]
        [Export("expandImage")]
        //[Verify(MethodToProperty)]
        UIImage ExpandImage { get; }

        // +(UIImage *)collapseImage;
        [Static]
        [Export("collapseImage")]
        //[Verify(MethodToProperty)]
        UIImage CollapseImage { get; }

        // +(UIImage *)forwardImage;
        [Static]
        [Export("forwardImage")]
        //[Verify(MethodToProperty)]
        UIImage ForwardImage { get; }

        // +(UIImage *)rewindImage;
        [Static]
        [Export("rewindImage")]
        //[Verify(MethodToProperty)]
        UIImage RewindImage { get; }

        // +(UIImage *)playImage;
        [Static]
        [Export("playImage")]
        //[Verify(MethodToProperty)]
        UIImage PlayImage { get; }

        // +(UIImage *)pauseImage;
        [Static]
        [Export("pauseImage")]
        //[Verify(MethodToProperty)]
        UIImage PauseImage { get; }

        // +(UIImage *)thumbImage;
        [Static]
        [Export("thumbImage")]
        //[Verify(MethodToProperty)]
        UIImage ThumbImage { get; }

        // +(UIImage *)routeImage;
        [Static]
        [Export("routeImage")]
        //[Verify(MethodToProperty)]
        UIImage RouteImage { get; }

        // +(UIImage *)routeOnImage;
        [Static]
        [Export("routeOnImage")]
        //[Verify(MethodToProperty)]
        UIImage RouteOnImage { get; }

        // +(UIImage *)castOffImage;
        [Static]
        [Export("castOffImage")]
        //[Verify(MethodToProperty)]
        UIImage CastOffImage { get; }

        // +(UIImage *)castOnImage;
        [Static]
        [Export("castOnImage")]
        //[Verify(MethodToProperty)]
        UIImage CastOnImage { get; }

        // +(UIImage *)castOn0Image;
        [Static]
        [Export("castOn0Image")]
        //[Verify(MethodToProperty)]
        UIImage CastOn0Image { get; }

        // +(UIImage *)castOn1Image;
        [Static]
        [Export("castOn1Image")]
        //[Verify(MethodToProperty)]
        UIImage CastOn1Image { get; }

        // +(UIImage *)castOn2Image;
        [Static]
        [Export("castOn2Image")]
        //[Verify(MethodToProperty)]
        UIImage CastOn2Image { get; }

        // +(UIImage *)volumeImage;
        [Static]
        [Export("volumeImage")]
        //[Verify(MethodToProperty)]
        UIImage VolumeImage { get; }
    }

    // @interface OOScalableImageButton : UIButton
    [BaseType(typeof(UIButton))]
    interface OOScalableImageButton
    {
        ...
        IntPtr Constructor(nfloat scale);
    }

    // @interface OOClosedCaptionsButton : OOScalableImageButton
    [BaseType(typeof(OOScalableImageButton))]
    interface OOClosedCaptionsButton
    {
    }

    // @interface OOAdsLearnMoreButton : UIView <UIWebViewDelegate>
    [BaseType(typeof(UIView))]
    interface OOAdsLearnMoreButton : IUIWebViewDelegate
    {
        // -(id)initWithAdPlayer:(OOAdMoviePlayer *)AdsPlayer;
        [Export("initWithAdPlayer:")]
        IntPtr Constructor(OOAdsLearnMoreButton AdsPlayer);
    ...
    [BaseType(typeof(OOScalableImageButton))]
    interface OOFullscreenButton
    {
    }

    // @interface OOPlayPauseButton : OOScalableImageButton
    [BaseType(typeof(OOScalableImageButton))]
    interface OOPlayPauseButton
    {
        // @property (nonatomic) BOOL isPlayShowing;
        [Export("isPlayShowing")]
        bool IsPlayShowing { get; set; }
    }

    // @interface OOVideoGravityButton : OOScalableImageButton
    [BaseType(typeof(OOScalableImageButton))]
    interface OOVideoGravityButton
    {
        // -(void)setIsGravityFillShowing:(BOOL)isGravityFillShowing;
        [Export("setIsGravityFillShowing:")]
        void SetIsGravityFillShowing(bool isGravityFillShowing);
    }

    // @interface ScrubberSliderFraming : NSObject
    [BaseType(typeof(NSObject))]
    interface ScrubberSliderFraming
    {
        // +(CGRect)calculateScrubberSliderFrameWithButtons:(NSArray *)buttonArray baseWidth:(CGFloat)baseWidth;
        [Static]
        [Export("calculateScrubberSliderFrameWithButtons:baseWidth:")]
        //[Verify(StronglyTypedNSArray)]
        CGRect CalculateScrubberSliderFrameWithButtons(NSObject[] buttonArray, nfloat baseWidth);
    }

    // @interface OOVolumeButton : OOScalableImageButton
    [BaseType(typeof(OOScalableImageButton))]
    interface OOVolumeButton
    {
    }
    ...
    //[Field("PlayerErrorNotification", "__Internal")]
    ...
    interface OOOoyalaAPIClient
    {
        ...
        // -(id)initWithPlayerAPIClient:(OOPlayerAPIClient *)playerAPI secureUrlGenerator:(id<OOSecureURLGenerator>)secureURLGenerator;
    ...
    [BaseType(typeof(NSObject))]
    interface OOAssetDownloadOptions : INSCopying
    {
        ...
        [Export("domain", ArgumentSemantic.Assign)]
        OOPlayerDomain Domain { get; set; }

        // @property (nonatomic, weak) id<OOEmbedTokenGenerator> embedTokenGenerator;
        [Export("embedTokenGenerator", ArgumentSemantic.Weak)]
        OOEmbedTokenGenerator EmbedTokenGenerator { get; set; }
        ...
        [Export("minimumBitrate", ArgumentSemantic.Assign)]
        NSNumber MinimumBitrate { get; set; }
        ...
        [Export("fakeURLScheme")]
        string FakeURLScheme { get; set; }
    }

    // @interface OOAssetDownloadStream : NSObject
    [BaseType(typeof(NSObject))]
    [DisableDefaultCtor]
    interface OOAssetDownloadStream
    {
        ...
        // -(instancetype)initWithDict:(NSDictionary *)data __attribute__((objc_designated_initializer));
        [Export("initWithDict:")]
        [DesignatedInitializer]
        IntPtr Constructor(NSDictionary data);
    }
    ...
    {
        // @required -(void)downloadManager:(OOAssetDownloadManager *)manager downloadTaskStartedWithError:(OOOoyalaError *)error;
        [Abstract]
        [Export("downloadManager:downloadTaskStartedWithError:")]
        void DownloadTaskStartedWithError(OOAssetDownloadManager manager, OOOoyalaError error);

        // @required -(void)downloadManager:(OOAssetDownloadManager *)manager downloadCompletedAtLocation:(NSURL *)location withError:(OOOoyalaError *)error;
        [Abstract]
        [Export("downloadManager:downloadCompletedAtLocation:withError:")]
        void DownloadCompletedAtLocation(OOAssetDownloadManager manager, NSUrl location, OOOoyalaError error);

        // @required -(void)downloadManager:(OOAssetDownloadManager *)manager downloadPercentage:(Float64)percentage;
        [Abstract]
        [Export("downloadManager:downloadPercentage:")]
        void DownloadPercentage(OOAssetDownloadManager manager, double percentage);

        // @required -(void)downloadManager:(OOAssetDownloadManager *)manager persistedContentKeyAtLocation:(NSURL *)location;
        [Abstract]
        [Export("downloadManager:persistedContentKeyAtLocation:")]
        void PersistedContentKeyAtLocation(OOAssetDownloadManager manager, NSUrl location);
    }
    ...
    [BaseType(typeof(NSObject))]
    [DisableDefaultCtor]
    interface OOAssetDownloadManager
    {
        // @property (readonly, getter = isDownloadActive, nonatomic) BOOL downloadActive;
        [Export("downloadActive")]
        bool DownloadActive { [Bind("isDownloadActive")] get; }
        ...
        [Wrap("WeakDelegate")]
        OOAssetDownloadManagerDelegate Delegate { get; set; }

        // @property (nonatomic, weak) id<OOAssetDownloadManagerDelegate> delegate;
        [NullAllowed, Export("delegate", ArgumentSemantic.Weak)]
        NSObject WeakDelegate { get; set; }

        // -(instancetype)initWithOptions:(OOAssetDownloadOptions *)options __attribute__((objc_designated_initializer));
        [Export("initWithOptions:")]
        [DesignatedInitializer]
        IntPtr Constructor(OOAssetDownloadOptions options);
        ...
        [Export("getstreams")]
        //[Verify(MethodToProperty)]
        OOAssetDownloadStream[] Getstreams { get; }

        // +(BOOL)deleteFileAtLocation:(NSURL *)location;
        [Static]
        [Export("deleteFileAtLocation:")]
        bool DeleteFileAtLocation(NSUrl location);
    }
    ...
    interface OOCastManagerProtocol
    {
        ...
        // TODO: Try to fix this so you don't have to cast..
        [Abstract]
        [Export("castPlayer")]
